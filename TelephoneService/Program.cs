...
using TelephoneServices;
using TelephoneServices.Interfaces;
using TelephoneServices.Services;
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "TelephoneServiceAPI"));
